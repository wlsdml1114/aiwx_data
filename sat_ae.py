...
print("sat image feature extraction..")
...
class LitAutoEncoder(pl.LightningModule):
    ...
    def __init__(self, hidden_dim: int = 64):
        ...
        self.decoder = nn.Sequential(
            nn.ConvTranspose2d(32,16,kernel_size=5,stride = 4,padding=1,output_padding=1),
            nn.ReLU(),
            nn.ConvTranspose2d(16,8,kernel_size=5,stride = 4,padding=1,output_padding=2),
            nn.ReLU(),
...
model = LitAutoEncoder.load_from_checkpoint(os.path.join(model_path,'sat_ae.ckpt'))
